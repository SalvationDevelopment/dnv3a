package dn_fla
{
    ...
    dynamic public class ScissorsCard_299 extends MovieClip
    {
        ...
        public function ScissorsCard_299()
        {
        ...
        {
            mouseChildren = false;
            this.front_mc.front_mc.initialize("", "", "Scissors", "", "", "fusion", "Machine", "light", "Scissors beats paper but loses to rock.", "", "", "", "");
            this.glow_mc.visible = false;
