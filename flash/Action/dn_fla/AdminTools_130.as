package dn_fla
{
    ...
    dynamic public class AdminTools_130 extends MovieClip
    {
        ...
        public function init(param1:String, param2:int, param3:Function, param4:Function, param5:Function, param6:Function, param7:Function)
        {
            ...
            this.lock = param4;
            this.unlock = param5;
            this.trackEvent = param6;
            this.displayError = param7;
            if (param2 >= 2)
            {
        ...
        public function updateAction(event:Event = null)
        {
            ...
            switch(_loc_2)
            {
                ...
                case "Cancel duel":
                {
                    ...
                    this.reason_txt.visible = false;
                    this.strike_cb.visible = false;
                    this.perform_btn.label = "Cancel Duel";
                    this.perform_btn.y = 72;
                    this.status_lbl.visible = false;
                    this.strikes_lbl.visible = false;
                    _loc_3 = 97;
        ...
        public function showResults(param1:Array)
        {
            ...
            switch(param1[0])
            {
                ...
                case "Kick user":
                {
                    this.trackEvent("Admin Kick", this.username, this.username_txt.text);
                    this.result_txt.text = this.username_txt.text + " has been kicked";
                    break;
                }
                case "Cancel duel":
                {
                    this.result_txt.text = this.username_txt.text + "\'s duel has been canceled";
                    break;
                }
                case "Add warning":
                {
        ...
        function __setProp_action_cb_AdminTools_Layer1_0()
        {
            ...
            _loc_3 = [{label:"Ban Status", data:"Ban status"}, {label:"Warning Note", data:"Add warning"}, {label:"Ban User", data:"Ban user"}, {label:"Unban User", data:"Unban user"}, {label:"Kick User", data:"Kick user"}, {label:"Cancel Duel", data:"Cancel duel"}];
            _loc_5 = 0;
