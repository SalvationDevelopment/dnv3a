package dn_fla
{
    ...
    dynamic public class Watchers_292 extends MovieClip
    {
        ...
        public function initialize(param1:Array, param2:String, param3:int)
        {
            var _loc_5:Object = null;
            this.COMPONENT_FONT = param2;
            this.COMPONENT_SIZE = param3;
            this.watchers_mc.dataProvider = new DataProvider();
            this.num_admins_online = 0;
            var _loc_4:* = 0;
            while (_loc_4 < param1.length)
            {
                
                _loc_5 = {label:param1[_loc_4], data:param1[_loc_4], admin:int(param1[(_loc_4 + 1)])};
                if (_loc_5.admin)
                {
                ...
                this.watchers_mc.dataProvider.addItem(_loc_5);
                _loc_4 = _loc_4 + 2;
            }
