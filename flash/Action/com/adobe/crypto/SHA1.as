package com.adobe.crypto
{
    ...
    public class SHA1 extends Object
    {
        ...
        {
            var _loc_2:* = createBlocksFromByteArray(param1);
            var _loc_3:* = hashBlocks(_loc_2);
            return IntUtil.toHex(_loc_3.readInt(), true) + IntUtil.toHex(_loc_3.readInt(), true) + IntUtil.toHex(_loc_3.readInt(), true) + IntUtil.toHex(_loc_3.readInt(), true) + IntUtil.toHex(_loc_3.readInt(), true);
        }// end function
