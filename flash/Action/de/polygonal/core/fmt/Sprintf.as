            ...
            while (_loc_5 < _loc_6)
            {
                ...
                if (_loc_7 == 37)
                {
                    ...
                    else
                    {
                        ...
                        _loc_9 = 17;
                        if ((_loc_8 & _loc_9) == _loc_9)
                        {
                            Log.trace("warning: `0\' flag ignored with \'-\' flag in printf format", {fileName:"Sprintf.hx", lineNumber:161, className:"de.polygonal.core.fmt.Sprintf", methodName:"_format"});
                            _loc_8 = _loc_8 & -17;
                        }
                        _loc_9 = 6;
                        if ((_loc_8 & _loc_9) == _loc_9)
                        {
                            Log.trace("warning: ` \' flag ignored with \'+\' flag in printf format", {fileName:"Sprintf.hx", lineNumber:166, className:"de.polygonal.core.fmt.Sprintf", methodName:"_format"});
                            _loc_8 = _loc_8 & -5;
                        }
                        _loc_10 = false;
                        _loc_9 = 0;
                        ...
                        if ((_loc_13 & 16776960) != 0)
                        {
                            ...
                            else if ((_loc_13 & 131328) != 0)
                            {
                                ...
                                {
                                    _loc_8 = _loc_8 & -3;
                                    Log.trace("warning: `+\' flag used with `%s\' printf format", {fileName:"Sprintf.hx", lineNumber:283, className:"de.polygonal.core.fmt.Sprintf", methodName:"_format"});
                                }
                                if ((_loc_8 & 4) != 0)
                                {
                                    _loc_8 = _loc_8 & -5;
                                    Log.trace("warning: ` \' flag used with `%s\' printf format", {fileName:"Sprintf.hx", lineNumber:288, className:"de.polygonal.core.fmt.Sprintf", methodName:"_format"});
                                }
                                else if ((_loc_8 & 16) != 0)
                                {
                                    _loc_8 = _loc_8 & -17;
                                    Log.trace("warning: `0\' flag used with `%s\' printf format", {fileName:"Sprintf.hx", lineNumber:294, className:"de.polygonal.core.fmt.Sprintf", methodName:"_format"});
                                }
                                else if ((_loc_8 & 8) != 0)
                                {
                                    _loc_8 = _loc_8 & -9;
                                    Log.trace("warning: ` #\' flag used with `%s\' printf format", {fileName:"Sprintf.hx", lineNumber:300, className:"de.polygonal.core.fmt.Sprintf", methodName:"_format"});
                                }
                                if (_loc_13 == 131072)
                                {
                                    _loc_3++;
                            ...
                            else if ((_loc_13 & 10290688) != 0)
                            {
                                ...
                                else
                                {
                                    ...
                                    else if ((_loc_13 & 8388608) != 0)
                                    {
                                        _loc_19 = _loc_18;
                                        _loc_22 = _loc_19;
                                        _loc_21 = 32 - (_loc_22 < 0 ? (0) : (_loc_22 = _loc_22 | _loc_22 >> 1, _loc_22 = _loc_22 | _loc_22 >> 1 | _loc_22 >> 2, _loc_22 = _loc_22 | _loc_22 >> 1 | _loc_22 >> 2 | _loc_22 >> 4, _loc_22 = _loc_22 | _loc_22 >> 1 | _loc_22 >> 2 | _loc_22 >> 4 | _loc_22 >> 8, _loc_22 = _loc_22 | _loc_22 >> 1 | _loc_22 >> 2 | _loc_22 >> 4 | _loc_22 >> 8 | _loc_22 >> 16, _loc_23 = _loc_22, _loc_23 = _loc_22 - (_loc_23 >> 1 & 1431655765), _loc_23 = (_loc_23 >> 2 & 858993459) + (_loc_23 & 858993459), _loc_23 = (_loc_23 >> 4) + _loc_23 & 252645135, _loc_23 = ((_loc_23 >> 4) + _loc_23 & 252645135) + (_loc_23 >> 8), _loc_23 = ((_loc_23 >> 4) + _loc_23 & 252645135) + (_loc_23 >> 8) + (_loc_23 >> 16), 32 - (_loc_23 & 63)));
                                        _loc_17 = (_loc_19 & 1) > 0 ? ("1") : ("0");
                                        _loc_19 = _loc_19 >> 1;
                                        _loc_22 = 1;
                                        while (_loc_22 < _loc_21)
                                        {
                                            ...
                                            _loc_22++;
                                            _loc_23 = _loc_22;
                                            _loc_17 = ((_loc_19 & 1) > 0 ? ("1") : ("0")) + ((_loc_23 & 7) == 0 ? ("") : ("")) + _loc_17;
                                            _loc_19 = _loc_19 >> 1;
                                        }
                                        _loc_12 = _loc_17;
                                        if (_loc_11 > 1)
