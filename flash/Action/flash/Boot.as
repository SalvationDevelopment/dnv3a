package flash
{
    ...
    dynamic public class Boot extends MovieClip
    {
        ...
        public function Boot(param1:MovieClip = ) : void
        {
            if (Boot.skip_constructor)
            {
                return;
            }
            var _loc_2:* = Array.prototype;
            _loc_2.copy = function ()
            {
                return this.slice();
            }// end function
            ;
            _loc_2.insert = function (param1, param2) : void
            {
                this.splice(param1, 0, param2);
                return;
            }// end function
            ;
            _loc_2.remove = function (param1) : Boolean
            {
                ...
                this.splice(_loc_2, 1);
                return true;
            }// end function
            ;
            _loc_2.iterator = function () : Object
            {
                var cur:int;
                var arr:String;
            ...
            ;
            _loc_2.setPropertyIsEnumerable("copy", false);
            _loc_2.setPropertyIsEnumerable("insert", false);
            _loc_2.setPropertyIsEnumerable("remove", false);
            _loc_2.setPropertyIsEnumerable("iterator", false);
            var cca:* = String.prototype.charCodeAt;
            String.prototype.charCodeAt = function (param1)
            {
                var _loc_2:* = cca.call(this, param1);
                if (isNaN(_loc_2))
                {
                    return null;
                }
            ...
            ;
            Boot.lines = [];
            var _loc_3:* = param1 == null ? (this) : (param1);
            Lib.current = _loc_3;
            if (Boot.init != null)
            {
                start();
