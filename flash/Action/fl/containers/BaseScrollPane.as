package fl.containers
{
    ...
    public class BaseScrollPane extends UIComponent
    {
        ...
        override protected function configUI() : void
        {
            ...
            var _loc_1:* = disabledOverlay.graphics;
        ...
        protected function calculateAvailableSize() : void
        {
            ...
            var _loc_2:* = _loc_6;
            var _loc_3:* = height - 2 * _loc_2 - vOffset;
            vScrollBar = _verticalScrollPolicy == ScrollPolicy.ON || _verticalScrollPolicy == ScrollPolicy.AUTO && contentHeight > _loc_3;
            var _loc_4:* = width - (vScrollBar ? (_loc_1) : (0)) - 2 * _loc_2;
            var _loc_5:* = useFixedHorizontalScrolling ? (_maxHorizontalScrollPosition) : (contentWidth - _loc_4);
