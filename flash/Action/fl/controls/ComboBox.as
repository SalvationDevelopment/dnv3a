package fl.controls
{
    ...
    public class ComboBox extends UIComponent implements IFocusManagerComponent
    {
        ...
        public function close() : void
        {
            ...
            _loc_1.removeEventListener(MouseEvent.MOUSE_DOWN, onStageClick);
            isOpen = false;
            _loc_1.removeChild(list);
            return;
        }// end function
        ...
        override protected function keyDownHandler(event:KeyboardEvent) : void
        {
            ...
            event.stopPropagation();
            var _loc_2:* = Math.max(calculateAvailableHeight() / list.rowHeight << 0, 1);
            var _loc_3:* = selectedIndex;
            var _loc_4:* = highlightedCell == -1 ? (selectedIndex) : (highlightedCell);
            var _loc_5:int = -1;
            switch(event.keyCode)
            {
                case Keyboard.SPACE:
