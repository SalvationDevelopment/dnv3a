package fl.controls
{
    ...
    public class ColorPicker extends UIComponent implements IFocusManagerComponent
    {
        ...
        {
            var _loc_1:* = colorWell;
            var _loc_2:* = getStyleValue("colorWell");
            if (_loc_2 != null)
            {
        ...
        {
            cleanUpSelected();
            var _loc_1:* = getStyleValue("swatchSelectedSkin");
            var _loc_2:* = getStyleValue("swatchPadding") as Number;
            if (_loc_1 != null)
            {
        ...
        protected function drawTextField() : void
        {
            ...
            var _loc_1:* = getStyleValue("backgroundPadding") as Number;
            ...
            var _loc_3:* = UIComponent.getStyleDefinition();
            var _loc_4:* = enabled ? (_loc_3.defaultTextFormat as TextFormat) : (_loc_3.defaultDisabledTextFormat as TextFormat);
            textField.setTextFormat(_loc_4);
            var _loc_5:* = getStyleValue("textFormat") as TextFormat;
            if (getStyleValue("textFormat") as TextFormat != null)
            {
        ...
        protected function drawSwatches() : void
        {
            ...
            var _loc_1:* = getStyleValue("backgroundPadding") as Number;
            var _loc_2:* = showTextField ? (textFieldBG.y + textFieldBG.height + _loc_1) : (_loc_1);
            swatches = new Sprite();
            palette.addChild(swatches);
            swatches.x = _loc_1;
            swatches.y = _loc_2;
            var _loc_3:* = getStyleValue("columnCount") as uint;
            var _loc_4:* = getStyleValue("swatchPadding") as uint;
            var _loc_5:* = getStyleValue("swatchWidth") as Number;
            var _loc_6:* = getStyleValue("swatchHeight") as Number;
            colorHash = {};
            swatchMap = [];
            var _loc_7:* = Math.min(1024, colors.length);
            var _loc_8:int = -1;
            var _loc_9:uint = 0;
            while (_loc_9 < _loc_7)
            {
        ...
        {
            var _loc_1:* = getStyleValue("background");
            if (_loc_1 != null)
            {
            ...
            var _loc_2:* = Number(getStyleValue("backgroundPadding"));
        ...
        protected function positionPalette() : void
        {
            ...
            var p:* = swatchButton.localToGlobal(new Point(0, 0));
            myForm = focusManager.form;
            p = myForm.globalToLocal(p);
            var padding:* = getStyleValue("backgroundPadding") as Number;
            try
            {
        ...
        override protected function keyUpHandler(event:KeyboardEvent) : void
        {
            ...
            if (editable && showTextField)
            {
                ...
                if (_loc_4.indexOf("#") > -1)
                {
                    _loc_4 = _loc_4.replace(/^\s+|\s+$""^\s+|\s+$/g, "");
        ...
        protected function setColorDisplay() : void
        {
            ...
            var _loc_1:* = new ColorTransform(0, 0, 0, 1, _selectedColor >> 16, _selectedColor >> 8 & 255, _selectedColor & 255, 0);
            setColorWellColor(_loc_1);
            setColorText(_selectedColor);
            var _loc_2:* = findSwatch(_selectedColor);
        ...
        protected function setSwatchHighlight(param1:Sprite) : void
        {
            ...
            var _loc_3:* = param1.getChildByName("color").transform.colorTransform.color;
        ...
        {
            var _loc_2:* = event.target.getChildByName("color").transform.colorTransform;
        ...
        {
            var _loc_2:* = event.target.getChildByName("color") as BaseButton;
            var _loc_3:* = _loc_2.transform.colorTransform;
            setColorWellColor(_loc_3);
        ...
        {
            var _loc_2:* = event.target.transform.colorTransform;
        ...
        protected function createSwatch(param1:uint) : Sprite
        {
            ...
            var _loc_3:* = new BaseButton();
            _loc_3.focusEnabled = false;
            var _loc_4:* = getStyleValue("swatchWidth") as Number;
            var _loc_5:* = getStyleValue("swatchHeight") as Number;
            ...
            var _loc_6:* = getStyleValue("swatchPadding") as Number;
            var _loc_7:* = _loc_2.graphics;
        ...
        override protected function keyDownHandler(event:KeyboardEvent) : void
        {
            ...
            var _loc_2:* = swatchMap[currRowIndex][currColIndex].getChildByName("color").transform.colorTransform;
