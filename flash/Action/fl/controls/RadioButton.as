package fl.controls
{
    ...
    public class RadioButton extends LabelButton implements IFocusManagerGroup
    {
        ...
        private function setPrev(param1:Boolean = true) : void
        {
            ...
            var _loc_4:* = _loc_2.getRadioButtonIndex(this);
            var _loc_5:* = _loc_2.getRadioButtonIndex(this);
            if (_loc_4 != -1)
            {
                do
                {
        ...
        private function setNext(param1:Boolean = true) : void
        {
            ...
            var _loc_4:* = _loc_2.getRadioButtonIndex(this);
            var _loc_5:* = _loc_2.numRadioButtons;
            var _loc_6:* = _loc_4;
            if (_loc_4 != -1)
            {
                do
