package fl.controls
{
    ...
    public class List extends SelectableList implements IFocusManagerComponent
    {
        ...
        {
            drawNow();
            var _loc_2:* = Math.floor((_verticalScrollPosition + availableHeight) / rowHeight) - 1;
            var _loc_3:* = Math.ceil(_verticalScrollPosition / rowHeight);
            if (param1 < _loc_3)
            {
        ...
        {
            var _loc_1:* = contentHeight != rowHeight * length;
        ...
        override protected function drawList() : void
        {
            ...
            var _loc_2:* = Math.floor(_verticalScrollPosition / rowHeight);
            var _loc_3:* = Math.min(length, _loc_2 + rowCount + 1);
        ...
        {
            var _loc_4:* = Math.max(Math.floor(calculateAvailableHeight() / rowHeight), 1);
            var _loc_5:int = -1;
            var _loc_6:int = 0;
            switch(param1)
            {
