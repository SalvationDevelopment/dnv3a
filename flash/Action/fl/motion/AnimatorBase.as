package fl.motion
{
    ...
    public class AnimatorBase extends EventDispatcher
    {
        ...
        public function set time(param1:int) : void
        {
            ...
            var _loc_5:* = _loc_2.getCurrentKeyframe(param1).index == this._lastRenderedTime && (!_loc_3 || this._lastRenderedMotion == _loc_2) && !_loc_4.tweensLength;
            if (_loc_2.getCurrentKeyframe(param1).index == this._lastRenderedTime && (!_loc_3 || this._lastRenderedMotion == _loc_2) && !_loc_4.tweensLength)
            {
                return;
            }
            if (_loc_4.blank)
        ...
        public function set instanceFactoryClass(param1:Class) : void
        {
            ...
            try
            {
                ...
                this.instanceFactory = _loc_3.this._instanceFactoryClass["getSingleton"]();
            }
            catch (e:Error)
            {
        ...
        public function play(param1:int = -1, param2:Boolean = true) : void
        {
            ...
            if (!this._isPlaying)
            {
                if (this._target == null && this._targetParent && this._targetName != "")
                {
                    ...
                    if (this.instanceFactory == null || _loc_6.this.instanceFactory["isTargetForFrame"](_loc_3, param1, this.sceneName))
                    {
                        this.target = _loc_3;
                    }
                    if (!this.target)
                    {
                        ...
                        {
                            var _loc_6:* = this.instanceFactory;
                            _loc_4 = _loc_6.this.instanceFactory["getInstance"](this._targetParent, this._targetName, param1, this.sceneName);
                            if (_loc_4)
                            {
        ...
        private function placeholderButtonEnterFrameHandler(event:Event) : void
        {
            ...
            var _loc_2:* = _loc_4.this.instanceFactory["getInstance"](this._targetParentBtn, this._targetName, this._spanStart);
            if (_loc_2 == null)
            {
                return;
            }
        ...
        private function placeholderSpriteEnterFrameHandler(event:Event) : void
        {
            ...
            var _loc_2:* = _loc_3.this.instanceFactory["getInstance"](this._targetParent, this._targetName, 0);
            if (_loc_2 == null)
            {
                return;
            }
