package dn_fla
{
    ...
    dynamic public class DuelCardHidden_338 extends MovieClip
    {
        ...
        public function DuelCardHidden_338()
        {
        ...
        public function cardOverE(event:MouseEvent)
        {
            ...
            if (this.duelist && this.xyz_card != null && this.xyz_card != this.card_over && this.card_over.loc == "field1" && !this.card_over.show_back && this.card_over.position >= 6 && this.card_over.front_mc.card != "token" && this.card_over.front_mc.card != "xyz")
            {
        ...
        public function showMenu(param1:DuelCard)
        {
            ...
            if (_loc_2.length > 0)
            {
                _loc_11 = new DuelCardMenu();
                _loc_11.initialize(new DataProvider(_loc_2), this.cardMenuClick, param1);
                _loc_11.addEventListener(MouseEvent.ROLL_OUT, this.menuRollOutE);
                this.menu_mc.addChild(_loc_11);
                this.menu = _loc_11;
        ...
        public function init(param1:Boolean, param2:int, param3:Function, param4:Number, param5, param6:Function, param7:Function, param8:Function, param9:Function, param10:SquarePicture)
        {
            this.duelist = param1;
            this.admin = param2;
        ...
        public function removeCard(param1:String, param2:String = null, param3:Array = null) : DuelCard
        {
            ...
            switch(param1)
            {
                ...
                case "underlay":
                {
                    ...
                    while (_loc_6.loc != "field1" && _loc_6.loc != "field2")
                    {
        ...
        public function addCard(param1:DuelCard, param2:String, param3:Object = null, param4:Boolean = false, param5:Boolean = false, param6:Array = null, param7:Boolean = false)
        {
            ...
            switch(param2)
            {
                ...
                case "field1":
                {
                    ...
                    if (this.duelist && !param4 && param1.position >= 6 && param1.front_mc.card != "token" && param1.front_mc.card != "xyz")
                    {
        ...
        public function updateView()
        {
            ...
            while (_loc_2 != null)
            {
                ...
                _loc_2.x = _loc_3;
                _loc_2.y = _loc_4;
                if ((_loc_2.loc == "rfg1" || _loc_2.loc == "rfg2") && _loc_2.show_back)
                {
                    _loc_2.cardRotationY = 180;
                }
                else
