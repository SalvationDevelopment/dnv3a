package fl.controls
{
    ...
    public class ScrollBar extends UIComponent
    {
        ...
        protected function thumbPressHandler(event:MouseEvent) : void
        {
            ...
            _loc_2.addEventListener(MouseEvent.MOUSE_MOVE, handleThumbDrag, false, 0, true);
            _loc_2.addEventListener(MouseEvent.MOUSE_UP, thumbReleaseHandler, false, 0, true);
            return;
        }// end function

        protected function handleThumbDrag(event:MouseEvent) : void
        {
            var _loc_2:* = Math.max(0, Math.min(track.height - thumb.height, mouseY - track.y - thumbScrollOffset));
        ...
        protected function thumbReleaseHandler(event:MouseEvent) : void
        {
            ...
            var _loc_2:* = focusManager.form;
            _loc_2.removeEventListener(MouseEvent.MOUSE_MOVE, handleThumbDrag);
            _loc_2.removeEventListener(MouseEvent.MOUSE_UP, thumbReleaseHandler);
            return;
        }// end function

        public function setScrollPosition(param1:Number, param2:Boolean = true) : void
        {
            var _loc_3:* = scrollPosition;
