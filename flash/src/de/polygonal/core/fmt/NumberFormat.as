package de.polygonal.core.fmt
{
    ...
    public class NumberFormat extends Object
    {
        ...
        public static function toBin(param1:int, param2:String = "") : String
        {
            var _loc_5:int = 0;
            var _loc_4:* = param1;
            var _loc_3:* = 32 - (param1 < 0 ? (0) : (_loc_4 = _loc_4 | _loc_4 >> 1, _loc_4 = _loc_4 | _loc_4 >> 1 | _loc_4 >> 2, _loc_4 = _loc_4 | _loc_4 >> 1 | _loc_4 >> 2 | _loc_4 >> 4, _loc_4 = _loc_4 | _loc_4 >> 1 | _loc_4 >> 2 | _loc_4 >> 4 | _loc_4 >> 8, _loc_4 = _loc_4 | _loc_4 >> 1 | _loc_4 >> 2 | _loc_4 >> 4 | _loc_4 >> 8 | _loc_4 >> 16, _loc_5 = _loc_4, _loc_5 = _loc_4 - (_loc_5 >> 1 & 1431655765), _loc_5 = (_loc_5 >> 2 & 858993459) + (_loc_5 & 858993459), _loc_5 = (_loc_5 >> 4) + _loc_5 & 252645135, _loc_5 = ((_loc_5 >> 4) + _loc_5 & 252645135) + (_loc_5 >> 8), _loc_5 = ((_loc_5 >> 4) + _loc_5 & 252645135) + (_loc_5 >> 8) + (_loc_5 >> 16), 32 - (_loc_5 & 63)));
            var _loc_6:* = (param1 & 1) > 0 ? ("1") : ("0");
            param1 = param1 >> 1;
            _loc_4 = 1;
            while (_loc_4 < _loc_3)
            {
                ...
                _loc_4++;
                _loc_5 = _loc_4;
                _loc_6 = ((param1 & 1) > 0 ? ("1") : ("0")) + ((_loc_5 & 7) == 0 ? (param2) : ("")) + _loc_6;
                param1 = param1 >> 1;
            }
            return _loc_6;
        }// end function
        ...
        public static function toHex(param1:int) : String
        {
            ...
            else
            {
                ...
                while (_loc_3 > 0)
                {
                    ...
                    _loc_4 = _loc_3 & 15;
                    switch(_loc_4) branch count is:<15>[53, 53, 53, 53, 53, 53, 53, 53, 53, 53, 64, 76, 88, 100, 112, 124] default offset is:<53>;
